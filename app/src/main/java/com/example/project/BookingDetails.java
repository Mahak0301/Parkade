    ...
    private void attachListeners() {
        db.getReference().child("BookedSlots").child(UUID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                findViewById(R.id.openInvoicePdf).setOnClickListener(BookingDetails.this);
                findViewById(R.id.shareInvoicePdf).setOnClickListener(BookingDetails.this);
...
//                                        }
    ...
    private void checkoutData() {
        ...
        db.getReference("ParkingAreas").child(bookingSlot.placeName).setValue(parkingArea).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
                    ...
                    db.getReference("BookedSlots").child(UUID).setValue(bookingSlot).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Intent notifyIntent = new Intent(getApplicationContext(), NotificationActionReceiver.class);
    ...
    private void attachParkingListeners(){
        db.getReference().child("ParkingAreas").child(bookingSlot.placeName)
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.openInvoicePdf){
            Toast.makeText(BookingDetails.this, "Open File", Toast.LENGTH_SHORT).show();
        ...
        else if(view.getId()==R.id.shareInvoicePdf) {
            Toast.makeText(BookingDetails.this, "Share File", Toast.LENGTH_SHORT).show();
            invoiceGenerator.downloadFile(bookingSlot.userID, UUID, BookingDetails.this, getApplication());
            ...
            case AppConstants.UPI_PAYMENT:
                ...
                if ((RESULT_OK == resultCode) || (resultCode == 11)) {
                    if (data != null) {
                        ...
                        Log.d(String.valueOf(BookingDetails.this.getClass()),"UPI:"+ "onActivityResult: " + trxt);
                        ...
                        for (String pair : pairs) {
                            ...
                            try{
                                ...
                                paid=upiPayment.upiPaymentDataOperation(myMap,BookingDetails.this);
                            }catch(Exception e){
                                myMap.put("status", "-1");
                                paid=upiPayment.upiPaymentDataOperation(myMap,BookingDetails.this);
                            }
                        ...
                        Log.d(String.valueOf(BookingDetails.this.getClass()),"UPI:"+"onActivityResult: " + "Return data is null");
                        Map<String, String> myMap = new HashMap<String, String>();
                        myMap.put("status", "-1");
                        paid=upiPayment.upiPaymentDataOperation(myMap,BookingDetails.this);
                    }
                } else {
                    Log.d(String.valueOf(BookingDetails.this.getClass()),"UPI:"+ "onActivityResult: " + "Return data is null"); //when user simply back without payment
                    Map<String, String> myMap = new HashMap<String, String>();
                    myMap.put("status", "-1");
                    paid=upiPayment.upiPaymentDataOperation(myMap,BookingDetails.this);
                }
