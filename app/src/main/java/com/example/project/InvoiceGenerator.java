...
public class InvoiceGenerator {
    ...
    public InvoiceGenerator(BookedSlots bookingSlot, ParkingArea parkingArea, String key, UserDetails userObj, File file){
    ...
    public void create(){
        ...
        paint.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText(userObj.phone,canvas.getWidth()-50,320,paint);
